...
public class VentanaMascotasUsuario extends JFrame {

	private static final long serialVersionUID = 1L;
	private Usuario user;
	private VentanaPerfil ventanaPerfil;
	private ArrayList<Animal> animales = user.getMascotas();
	
	VentanaMascotasUsuario(Usuario user, VentanaPerfil ventanaPerfil) {
		this.setTitle("MASCOTAS DE - " + user.getNombre() + " " + user.getApellido());
		...
		panelTitulo.setBorder(BorderFactory.createTitledBorder(
				...
				":)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(80, 55, 30)
				));
	
		JLabel titulo = new JLabel();
		titulo.setText("MASCOTAS DE - " + user.getNombre() + " " + user.getApellido());
	...
	for (int i = 0; i < 12; i++) {
		...
		panel.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(new Color(80, 55, 30)), 
				animales.get(i).getNombre(), TitledBorder.LEFT, TitledBorder.TOP, null, new Color(80, 55, 30)
				));
		paneles[i] = panel;
...
private void mostrarCaracteristicas(int indiceGato) {
	...
	panelPerfil.setBorder(BorderFactory.createTitledBorder(
			BorderFactory.createLineBorder(new Color(80, 55, 30)), 
			animales.get(indiceGato).sonidoAnimales(), TitledBorder.LEFT, TitledBorder.TOP, null, new Color(80, 55, 30)
			));
	...
	//Gato gato = animales.get(indiceGato)
